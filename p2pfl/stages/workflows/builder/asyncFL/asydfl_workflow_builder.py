...
from p2pfl.stages.workflows.models.asyncFL.async_event_handler import AsyncEventHandlerWorkflowModel
from p2pfl.stages.workflows.models.asyncFL.async_event_handler import get_states as get_event_handler_states
from p2pfl.stages.workflows.models.asyncFL.async_event_handler import get_transitions as get_event_handler_transitions
...
class AsyDFLWorkflowBuilder(WorkflowBuilder):
    ...
    def create_training_workflow_model(self, node: Node) -> None:
        ...
        self._workflow_state_manager.add_learning_workflow(AsyncLearningWorkflowModel(node, self._network_state))
    ...
    def create_event_handler_workflow_model(self, node: Node) -> None:
        ...
        self._workflow_state_manager.add_event_handler_workflow(
            AsyncEventHandlerWorkflowModel(node, self._network_state)
        )
